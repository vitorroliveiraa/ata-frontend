...
import TimeInput from "@/components/inputs/timeInput/index.tsx";
import RadioGroupInput from "@/components/inputs/radioGroupInput/index.tsx";
import FileInput from "@/components/fileInput/index.tsx";
import { Button } from "@/components/ui/button.tsx";
import DefaultButton from "@/components/button/index.tsx";
import { Label } from "@/components/ui/label.tsx";
import { TimePickerInput } from "@/components/inputs/timePicker/timePicker.tsx";
...
const Registration = () => {
  ...
  const [date, setDate] = useState<Date | undefined>(
    0 ? new Date(0) : undefined
  );
  const [minute, setMinute] = useState(0);

  return (
    <main className="max-w-3xl w-full self-center">
            ...
            <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
                <SelectInput
                  ...
                  selectLabel="Documentos válidos"
              ...
              <div className="sm:col-span-3">
                <SelectInput
                  ...
                  selectLabel="Documentos permitidos"
